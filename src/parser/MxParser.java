...
public class MxParser extends Parser {
	...
	public static final int
		...
		LeftShift=16, BitAnd=17, BitOr=18, BitXor=19, BitNot=20, Assign=21, Increase=22, 
		Decrease=23, Dot=24, Question=25, Colon=26, Semi=27, Comma=28, Quite=29, 
		LeftParen=30, RightParen=31, LeftBracket=32, RightBracket=33, LeftBrace=34, 
		RightBrace=35, Void=36, Bool=37, Int=38, String=39, New=40, Class=41, 
		Null=42, True=43, False=44, This=45, If=46, Else=47, For=48, While=49, 
		Break=50, Continue=51, Return=52, Identifier=53, ConstantInt=54, ConstantStr=55, 
		Whitespace=56, Newline=57, BlockComment=58, LineComment=59;
	public static final int
		RULE_program = 0, RULE_funcDef = 1, RULE_parameter = 2, RULE_unitParameter = 3, 
		RULE_classDef = 4, RULE_classConstructor = 5, RULE_varDef = 6, RULE_unitVarDef = 7, 
		RULE_returnType = 8, RULE_defType = 9, RULE_baseType = 10, RULE_suite = 11, 
		RULE_realParameter = 12, RULE_statement = 13, RULE_expression = 14, RULE_primary = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "funcDef", "parameter", "unitParameter", "classDef", "classConstructor", 
			"varDef", "unitVarDef", "returnType", "defType", "baseType", "suite", 
			"realParameter", "statement", "expression", "primary"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BitAnd", "BitOr", "BitXor", "BitNot", "Assign", "Increase", "Decrease", 
			"Dot", "Question", "Colon", "Semi", "Comma", "Quite", "LeftParen", "RightParen", 
			"LeftBracket", "RightBracket", "LeftBrace", "RightBrace", "Void", "Bool", 
			"Int", "String", "New", "Class", "Null", "True", "False", "This", "If", 
			"Else", "For", "While", "Break", "Continue", "Return", "Identifier", 
			"ConstantInt", "ConstantStr", "Whitespace", "Newline", "BlockComment", 
			"LineComment"
		};
	}
	...
	public static class UnitParameterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxParserVisitor ) return ((MxParserVisitor<? extends T>)visitor).visitUnitParameter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class UnitVarDefContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_unitVarDef; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxParserVisitor ) return ((MxParserVisitor<? extends T>)visitor).visitUnitVarDef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RealParameterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxParserVisitor ) return ((MxParserVisitor<? extends T>)visitor).visitRealParameter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PreExprContext extends ExpressionContext {
		...
		public TerminalNode Increase() { return getToken(MxParser.Increase, 0); }
		public TerminalNode Decrease() { return getToken(MxParser.Decrease, 0); }
	...
	public static class IdentifyContext extends PrimaryContext {
		public TerminalNode Identifier() { return getToken(MxParser.Identifier, 0); }
		public IdentifyContext(PrimaryContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class LiteralContext extends PrimaryContext {
		public TerminalNode ConstantInt() { return getToken(MxParser.ConstantInt, 0); }
		public TerminalNode ConstantStr() { return getToken(MxParser.ConstantStr, 0); }
